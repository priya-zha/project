...
model = LogisticRegressionModel.load('hdfs://master:9000/model')
#Connect to Kafka
...
#      test_df = spark.read.csv("/content/files/newfile.csv",header=True,inferSchema=True)
       ...
       # results.printSchema()
        ...
        for i in range(0,len(diabetes_list)):
            batch.add(SimpleStatement("INSERT INTO diabetesb(Anonymous_name,Pregnancies,Glucose,BloodPressure,SkinThickness,Insulin,BMI,DiabetesPedigreeFunction,Age,created_at,location,prediction) VALUES (%s, %s ,%s, %s, %s, %s, %s ,%s,%s,%s,%s,%s)"), (diabetes_list[0], diabetes_list[1],diabetes_list[2],diabetes_list[3],diabetes_list[4],diabetes_list[5],diabetes_list[6],diabetes_list[7],diabetes_list[8],diabetes_list[9],diabetes_list[10],int(diabetes_list[14])))
           # batch.add(SimpleStatement("INSERT INTO diabetesb(name, age,glucose,bloodpressure,skinthickness,insulin,diabetespedigreefunction,bmi,pregnancies,prediction) VALUES (%s, %s, %s ,%s, %s, %s, %s, %s ,%s,%s)"), (diabetes_list[0], diabetes_list[1],diabetes_list[2],diabetes_list[3],diabetes_list[4],diabetes_list[5],diabetes_list[6],diabetes_list[7],diabetes_list[8],int(diabetes_list[12])))
            ...
            batch_one.add(SimpleStatement("INSERT INTO privateb(name,prediction) VALUES (%s, %s)"), (diabetes_list[0], int(diabetes_list[14])))
